    ...
    <div className="min-h-screen flex items-center justify-center bg-slate-50 text-slate-800 dark:bg-darkbg dark:text-slate-100 p-6 relative overflow-hidden">
      ...
      <div className="w-full max-w-lg z-10">
        <div className="text-center mb-8">
          ...
          <p className="text-sm text-slate-500 dark:text-slate-400 mt-2">Join the BAMP AI Orthodontics Research Portal</p>
        </div>

        <div className="bg-white dark:bg-slate-900 border border-slate-200/60 dark:border-slate-805/85 rounded-3xl p-8 shadow-xl shadow-slate-100 dark:shadow-none">
            ...
            <div className="space-y-1.5">
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full pl-12 pr-4 py-2.5 bg-slate-50 dark:bg-slate-800/50 border border-slate-200 dark:border-slate-800 rounded-xl focus:outline-none focus:ring-2 focus:ring-medical-500/20 focus:border-medical-500 transition-all font-medium"
                />
              </div>
          ...
          <div className="relative my-6">
            ...
            <div className="relative flex justify-center text-xs uppercase tracking-wider font-bold">
              <span className="bg-white dark:bg-slate-900 px-4 text-slate-400">Or registration via</span>
            </div>
          </div>
          ...
          <button
            ...
            disabled={isLoading}
            className="w-full py-3 bg-slate-50 dark:bg-slate-800 hover:bg-slate-100 dark:hover:bg-slate-700/80 border border-slate-200 dark:border-slate-850 rounded-2xl flex items-center justify-center space-x-3 transition-colors duration-200 font-semibold text-sm"
          >
          ...
          <p className="text-center text-xs mt-6 font-semibold text-slate-500">
            Already have an account? <Link to="/login" className="text-medical-500 hover:underline">Doctor Login</Link>
          </p>
        </div>
      </div>
    </div>
